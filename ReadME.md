...
Brayton Lordianto
Apple | Berkeley EECS, NYU | 2x  Apple Vision Pro SWE Intern | XR 3D graphics, Networks, and HCI Research | MLH Top 50

Technical Portfolio:
![https://brayton.website](https://brayton.website)
...
I started with Java in high school, and then I discovered C and C++ — my strongest programming language.
In other courses and hackathons (or code festivals), I learned about Swift, Python, SQL, NoSQL, HTML, CSS, and JavaScript, which I used mainly to create visualizations, servers, or applications.

Passion for Programming, Teamwork, and Innovation? ✅
...
I am a current Professional Development organizer for PERMIAS NYC, New York’s city-wide Indonesian association. It can be hard for Indonesian students to know where to start with professional development, and I help organize events that better inform their career choices.
I have spent the last 4 years creating an inclusive community for Indonesian students in the international space and have organized many events to share Indonesian culture with others; I am honored to have been the Freshman Rep for NYU’s Indonesian club, a VP (1.5yr) and a Secretary (1.5yr) for my HS’ Indonesian association.
...
Requires Node 18 (Node 23 hangs on iCloud-hosted paths). With Homebrew:

```
PATH="/opt/homebrew/opt/node@18/bin:$PATH" npm install
PATH="/opt/homebrew/opt/node@18/bin:$PATH" npm start
```

Or with nvm: `nvm use 18 && npm start`. If port 3000 is busy: `lsof -ti:3000 | xargs kill -9`.
...
The project cards are called `GithubRepoCard`s.
